...
import (
	...
	"go-clean-architecture/pkg/csrf"
	...
	authRepository "go-clean-architecture/internal/auth/repository"
	authUseCase "go-clean-architecture/internal/auth/usecase"
	commentsHttp "go-clean-architecture/internal/comments/delivery/http"
	commentsRepository "go-clean-architecture/internal/comments/repository"
	commentsUseCase "go-clean-architecture/internal/comments/usecase"
	apiMiddlewares "go-clean-architecture/internal/middleware"
	newsHttp "go-clean-architecture/internal/news/delivery/http"
	newsRepository "go-clean-architecture/internal/news/repository"
	newsUseCase "go-clean-architecture/internal/news/usecase"
	sessionRepository "go-clean-architecture/internal/session/repository"
	"go-clean-architecture/internal/session/usecase"
	"go-clean-architecture/pkg/metric"
	"go-clean-architecture/pkg/utils"
)
